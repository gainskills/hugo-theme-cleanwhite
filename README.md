...
- +[Privacy Plicy](https://cookieconsent.insites.com/download)
- +[Share](https://www.addtoany.com/)
- +[See Also](https://gohugo.io/content-management/related/)
- +[fancybox](http://fancyapps.com/), [Image Processing](https://gohugo.io/content-management/image-processing/#image-processing-examples), [shortcode](https://gohugo.io/content-management/shortcodes/) for images (Enable this with "postWithImg: true")
- +[Lazy load images](https://blog.gainskills.top/2019/01/25/post-img-mgmt-hugo/#lazy-load-images)
- +[Google AdSense](https://www.google.com/adsense/login)
- +[Header hover anchor links](https://ben.balter.com/2014/03/13/pages-anchor-links/)
- +[Structured data](https://developers.google.com/search/docs/data-types/article)
- -Diabled all links to Baidu
- -Remove [leancloud](https://leancloud.cn/)
- -Remove Pygments highlight (syntax.css) because it conflicts with [Hugo Synatx Highlighting](https://gohugo.io/content-management/syntax-highlighting/)
- [Asset minification](https://gohugo.io/hugo-pipes/minification/#readout)
- Move reward option from global level to post level (also change how it load imgs)
- Some other minor adjustments

#### Demo
+ [Live demo site](https://blog.gainskills.top)
+ IMG Improvement

    [![2019-01-24 at 17.15.13.gif](https://i.loli.net/2019/01/27/5c4d0b5e1f117.gif "IMG Improvement")](https://blog.gainskills.top/2018/07/20/mininet-importerror-customclass/)
...
<img src="https://raw.githubusercontent.com/zhaohuabing/hugo-theme-cleanwhite/master/images/fullscreenshot.png" title="screenshot-Home" alt="screenshot-Home" style="max-height:500px" >

**Post**

<img src="https://raw.githubusercontent.com/zhaohuabing/hugo-theme-cleanwhite/master/images/post.png" title="screenshot-Post" alt="screenshot-Post" style="max-height:500px" >

**Search**

<img src="https://raw.githubusercontent.com/zhaohuabing/hugo-theme-cleanwhite/master/images/sitesearch.png" title="screenshot-Search" alt="screenshot-Search" style="max-height:300px" >


**Wechat Pay & Alipay**

<img src="https://raw.githubusercontent.com/zhaohuabing/hugo-theme-cleanwhite/master/images/rewards.png" title="screenshot-Reward" alt="screenshot-Reward" style="max-height:200px" >
